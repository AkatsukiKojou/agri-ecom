...
<div class="flex flex-col items-center gap-2 mb-6">
    <h1 class="text-2xl md:text-4xl lg:text-4xl font-extrabold text-green-800 tracking-tight">Products & Training Services Report</h1>
    <p class="text-sm md:text-base text-gray-500">Overview and analytics for your products & training services</p>
</div>
 <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <!-- Kanban Column for Completed Transactions -->
                <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200 flex flex-col gap-2">
                    <h2 class="text-xl font-extrabold text-gray-800 mb-2">All Completed Transactions</h2>
                    <div class="flex flex-col gap-1">
                        <div>
                            <span class="block text-gray-600 text-lg font-semibold">Total Completed</span>
                            <span class="text-3xl font-extrabold text-green-800">{{ $services_completed + $products_completed }}</span>
                        </div>
                        <div>
                            <span class="block text-gray-600 text-lg font-semibold mt-2">Total Income</span>
            ...
            <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200 flex flex-col gap-2">
                <h2 class="text-xl font-extrabold text-gray-800 mb-2 flex items-center"><span class="mr-2">✅</span> Orders Completed</h2>
                <div class="flex flex-col gap-1">
                    <div>
                        <span class="block text-gray-600 text-lg font-semibold">Total Orders Completed</span>
                        <span class="text-3xl font-extrabold text-green-800">{{ $products_completed }}</span>
                    </div>
                    <div>
                        <span class="block text-gray-600 text-lg font-semibold mt-2">Total Income</span>
                        <span class="text-3xl font-extrabold text-green-800">₱{{ number_format($completed_income, 2) }}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200 flex flex-col gap-2">
                <h2 class="text-xl font-extrabold text-gray-800 mb-2 flex items-center"><span class="mr-2">🛠️</span> Services Completed</h2>
                <div class="flex flex-col gap-1">
                    <div>
                        <span class="block text-gray-600 text-lg font-semibold">Total Services Completed</span>
                    ...
                    @forelse($topProducts as $product)
                        <div>
                            ...
                            <div class="w-full h-3 bg-gray-200 rounded-full">
                                <div class="h-3 rounded-full bg-yellow-500 transition-all duration-300" style="width: {{ ($product->total_qty / $maxQty) * 100 }}%"></div>
                            </div>
                        </div>
                    @empty
